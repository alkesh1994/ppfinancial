            ...
            <div class="row">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input type="text" id="client_phone_number" name="client_phone_number" class="form-control" value="{{old('client_phone_number') ? old('client_phone_number') : $client->client_phone_number}}" placeholder="Enter Client Phone Number">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input type="text" id="client_alternate_phone_number" name="client_alternate_phone_number" class="form-control" value="{{old('client_alternate_phone_number') ? old('client_alternate_phone_number') : $client->client_alternate_phone_number}}" placeholder="Enter Alternate Phone Number">
